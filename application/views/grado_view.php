...
<div class="container-fluid">
        ...
        <h1 style="font-size:20pt">Registro de Grados</h1>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('grado/ajax_list')?>",
            "type": "POST"
        },
...
function edit_person(id)
{
    ...
    $.ajax({
        ...
        {
            $('[name="COD_GRADO"]').val(data.COD_GRADO);
            $('[name="NOM_GRADO"]').val(data.NOM_GRADO);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Editar Grado'); // Set title to Bootstrap modal title
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('grado/ajax_add')?>";
    } else {
        url = "<?php echo site_url('grado/ajax_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Desea eliminar este registro?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('grado/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="NOM_GRADO" placeholder="Grado" class="form-control" type="text" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" onkeypress="return validar(event)">
